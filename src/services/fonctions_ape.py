...
def BACH_R11(code,tb,fp,df):
    ...
    response={"label":"ratio de solvabilité","valeur":ratio_de_solvabilite_en_fr,"unit":"%","quartile":Q_S,"score":score}
    return(response)
...
def BACH_R28(CodeAPE,DU,YQ,YR,YS,CG,EE,df):
    ...
    response={"label":"dette net sur total bilan'","valeur":ratio_R28_eu_percent,"unit":"%","quartile":Q,"score":score}
    return(response)